...
* Small: Size Category. Their Range is 1 yards.
* Medium: Size Category. Their Range is 2 yard.
* Large: Size Category. Their Range is 3 yards. 
* Extreme: Size Category. Their Range is 5 yards. Parrying with an Extreme Weapon has a \-3 Accuracy penalty and the Parry action’s Base Speed is increased to 4.  
