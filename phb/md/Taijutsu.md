...
Halting Blow is used as an unarmed parry, with a \+3 Accuracy bonus. If you successfully defend, Halting Blow immediately acts as an attack at no extra cost, using the results of your parry roll as its Accuracy and its speed for both damage and legal defenses from the opponent is equal to what it was when used as a defense. While Halting Blow is being treated as an attack, not while it is a parry, you may augment it as you would normal attacks and this allows for attack-movement as part of it while it is an attack. This does mean that Sudden Attack and like bonuses would apply and can be declared as the attack is declared.
...
Momentum: Your combo jutsu hit all enemies in range. If partial defense applies, this deals 25% damage per point you hit by, rather than 20%.
...
Effects: Gale may be used as an interrupt after you have successfully dodged an attack, targeting the attacker. If Gale is used after a dodge in this fashion, the dodge roll replaces Gale's accuracy. While Gale is being treated as an attack you may augment it as you would normal attacks and this allows for attack-movement as part of it while it is an attack. This does mean that Sudden Attack and like bonuses would apply and can be declared as the attack is being declared.

Alternatively, you may use Reppuu as a normal attack, using your regular Accuracy (rather than a dodge roll).
...
Your damage bonus is doubled for this attack. Even if it misses, the opponent might still be damaged by the shockwave (and destruction to the environment) the kick causes. For every point it misses by, your damage bonus is reduced by 10%, and its damage is reduced by 2d12.
...
Effects: If Kage Buyo hits, your opponent is considered to be knocked airborne until their next non-interrupt non-move Action. They do not suffer the effects of any Ground-Based Conditions until they land (on their next non-interrupt action) and may not perform the Move Action or the “Move with an Attack'' Maneuver, even on the Attack that ends their airborne state. They are also left exposed in the air, the next Unarmed/Combo Taijutsu or Basic Unarmed Attack you make against them while they’re airborne will gain a bonus to its Accuracy and a reduction to its Speed for every 2 points you beat their defense by, to a maximum of 3 Accuracy bonus and reduction to Speed.
...
Momentum: If used as the Opener of a Combo, All Combo Jutsus will knock the enemy back into the air or juggle them there,and the Attack following that Combo Jutsu will receive the appropriate Accuracy and Speed Reduction bonuses. 
...
This follows the rules for the D-rank Reppuu technique (including its Momentum). Should you hit, the opponent is knocked prone, as per the E-rank Trip's effects.
...
When used against a person, roll location as if it had caused a wound (unless it was a called shot; if blocked, the defender chooses the location as usual). Before wounds or damage are calculated, this completely destroys any armor protecting the location it hits.
...
If combined with the B-rank Leaping Shadow Evasion this technique increases LSE's Stamina cost to (10 \+ 5\*X), which replaces Phantom Step's normal Stamina cost.
...
Effects: This damages everyone in range. If partial defense applies, this technique does 50% of its normal damage per point it hits by, rather than 20%. Anyone hit is knocked back STR/20 Yards.
...
If this Jutsu is used while a Combo is being maintained it does not break the Combo.
...
This Jutsu cannot be used while a Combo is being maintained.
...
Effects:  
You are Clinching your opponent. This is not inherently a huge advantage, but leads into multiple other possibilities for attack. When clinched, the following effects apply to both participants:

\> Their movement speed is halved, and moves the other person along with them.  
\> If one tries to move, the other person may attempt to restrain you; if they do, your AGI is reduced by half their STR when calculating how far you can move.  
\> The Dodge and Parry interrupt both have their Base Speed increased by 2\.  
...
\> Neither person is capable of entering Stealth through any means (Even Ninjutsu or Genjutsu), and if they were hidden beforehand, then they’re automatically revealed to everybody in the battlefield (Hard to stay stealthy when you’re trying not to get man/womanhandled).

Certain situations within a grapple may call for a 'grapple roll'. When this happens, both player roll either Grapple Off or Def. Who does which of those two Checks depends on who it was that triggered the Check, with them being the one who rolls Off. Ties go to the person making the grapple roll.  
Grapple Off: 1d20 \+ STR/10 \+ AGI/20 \+ Any relevant bonuses \- Immobility  
Grapple Def: 1d20 \+ STR/10 \+ DEX/20 \+ Any relevant bonuses \- Immobility

Whilst in a clinch, either participant access to these two actions:  
Break Clinch (Stamina 5, Speed 5\) You make a Grapple roll versus your opponent. If you succeed, the grapple ends immediately. If you fail, your opponent gains \+5 to their roll next time you have to make a grapple roll against them, which does not stack with similar effects for failing grapple actions.  
Set-up (Stamina 10, Speed \+ 5\) This is an add-on to an attack. You force a grapple roll against anyone currently grappling you. If you succeed, your attacks get \+3 to its accuracy and gains \+0.5 to its Damage Bonus for each point their Grapple Roll fails to meet yours. The grapple ends after the attack is resolved. If you fail, the clinch does not end and your opponent gains \+5 to their roll next time you have to make a grapple roll against them, which does not stack with similar effects for failing grapple actions. The speed increase to the attack does not count for its damage or for its speed when it comes to calculating what defenses are legal versus it.

Finisher: When used as a finisher, this move gains \+(Cadence Rank) accuracy and a bonus of (Cadence Rank) to Grapple for (Cadence Rank \* 3\) IC. If you’ve taken the ability “Signature Move: Grab”, then you also gain another (Cadence Rank) bonus to Grapple Rolls, with your ranks in “Signature Move: Grab” as a cap to how much you can gain
...
Effects:  
You make a Grapple roll versus your opponent. The "X" in this jutsu's cost and speed is the amount your Grapple Off fails to meet their Def.  
Thus, if you rolled a 12 against your opponent's 16, Escape Grapple would be a Stamina 8 check and have a Speed of 8\.  
On the other hand, if you passed your check by 36 points, it would be only Stamina 4 and Speed 4\.  
If this is used in a clinch, you break the clinch. If this is used whilst pinned, you return to being clinched.  
This technique cannot be Aborted, despite its Delay.
...
Effects:  
This attack may be used if you are pinning an opponent, if you are pinned by an opponent, and also within a clinch, but only against someone grappling you.  
It automatically hits. If it causes a wound, that wound is automatically a head wound.  
Although the attacker does not take damage from doing this, if the damage they do would have caused them to be wounded, they will suffer that wound. For example, if you have 500 Vitality and Headbutt someone for 60 damage, you would take 0 damage and suffer a minor wound (for taking more than 10% of your HP in one hit).

## **Grapple D-rank**

### **Take Down**

Using a variety of techniques that can range from dropping your weight and bulldozing through an opponent to waiting for an opponent to take a step and then sweeping their foot, you somehow bring the grapple down onto the ground. This places your opponent onto the ground with your bodyweight on top of them.
...
Effects:  
This can only be done from a clinch.  
You force a grapple roll against anyone currently grappling you. If they fail, you have pinned your opponent. At this point you start keeping track of who is the “Attacker” and who is the “Defender” in the grapple, with whoever used Take Down as being the attacker. If they succeed, not only do you not pin your opponent, but they get a \+5 to their roll next time you have to make a grapple roll against them, which does not stack with similar effects for failing grapple actions.  
Whilst you have an opponent pinned, you have these effects applied to you.

\> Other Grapple jutsu may be used. Grapple jutsu cannot be defended against normally (i.e. dodging, blocking). Ordinary attacks, such as punching or stabbing the other grappler, can be defended against normally. Unless specified otherwise, all Grapple Jutsu may only be used by somebody who has an opponent pinned.  
\> Whilst you are pinning an opponent you cannot use handseals without the Single-Handed Seals unique.  
\> You can stop pinning your opponent and return to a clinch at any time, this drops any grapple locks you are currently maintaining.

Whilst pinned your opponent has access to this action:  
Break Grapple (Speed 4\) You force a grapple roll against an opponent currently pinning you; if they fail their grapple roll vs your grapple, the grapple returns to a clinch. When this is done, the attacker must roll a Stamina 5 check, or choose to return the grapple to a clinch.
...
Effects:  
This immediately ends the grapple, and Stuns the enemy, severity 4\. This can also be declared as part of a Grab attack, in which case it increases the total Speed by 4, and deals damage as a Speed 16 action. It cannot be blocked when used this way. The two Stamina rolls (one for a grab, and one for Throwing if the grab succeeds) are made separately.  
This move can be done from a clinch, but your opponent can make a grapple roll vs your grapple Off to defend. If they succeed, the attack does no damage, you do not end the clinch, and your opponent gets \+5 to their roll next time you have to make a grapple roll against them, which does not stack with similar effects for failing grapple actions.
...
Effects:  
You and your opponent both lose the ability to use one of your arms. This puts your opponent at a \-2 penalty to their grapple rolls, increases their grapple based immobility by 1, and doubles the Seal Speed of any jutsu they try to use (if used when your opponent is mid-seals, it doubles the remaining speed). Using this jutsu a second time doubles the penalties and makes it impossible for the victim to use handseals at all. A person with the Single-Handed Seals unique is able to perform handseals one-handed unhindered by these effects.  
...
Effects:  
You and your opponent both lose the ability to use one of your legs. This gives your opponent a \-2 penalty to their grapple checks, and increases their grapple based immobility by 1, as well as further halving the speed at which you and they can move in the grapple. If you lock back legs, both your and the opponent’s movement speed becomes 0\.  
If you lose control of the grapple, these effects end.
...
Effects:  
You lose the ability to use one of your arms, and you increase your opponent’s grapple based immobility penalty by 1, as well as a \-2 penalty to all their grapple rolls. For the duration of the headlock, the victim's Stamina rolls have a \-4 penalty.  
If you lose control of the grapple, these effects end.
...
Effects:  
You force a grapple roll versus an opponent pinning you. The "X" in this jutsu's cost and speed is the amount your opponent beats your grapple check by.  
Thus, if your opponent rolled a 16 against your Grapple roll of 12, Reversal would be a Stamina 8 check and have a Speed of 8\.  
On the other hand, if your opponent failed the check by 36 points, it would be only Stamina 4 and Speed 4\.  
When you perform this technique, you stop being pinned by your opponent, and instead pin them.  
This technique cannot be Aborted, despite its Delay.
...
Effects:  
To use this technique you must have your opponent in an arm or leg lock; if you have multiple limbs locked, declare which one you are targeting. Any wounds dealt by the joint lock are applied to that limb.  
Although the damage is dealt normally, it is considered cumulatively 50% higher each time you use the technique. For example, the first Joint Lock you apply does (STR/10)d8+(Speed)\*(PDB); the next, ((STR/10)d8+(Speed)\*(PDB)) \+50%; the third \+100%, and so forth, and so on.  
If you take an action other than maintaining the joint lock (including moving or using interrupts), this cumulative increase is reset.  
Each additional use of Joint Lock after the first adds \+2 to the stamina cost. Resetting the cumulative damage also resets the cumulative stamina cost.  
Joint Lock deals Piercing Wounds.
...
Effects:  
This requires the opponent already be in one of the three D-rank locks. Each time you use this technique applies a \-1 penalty to their grapple checks, and increases their grapple based immobility by 1, so long as that lock is maintained. This penalty remains until that lock is ended.
...
Effects:  
This ends the grapple. If Suplex inflicts a wound, it is dealt to the opponent's head.  
This move can be done from a clinch, but when it's done from a clinch instead of from a pin your opponent can make a grapple roll to defend. If they fail, your damage bonus increases by 1 for each point they fail by. If they succeed, the attack does no damage, you do not end the clinch, and your opponent gets \+5 to their roll next time you have to make a grapple roll against them, which does not stack with similar effects for failing grapple actions.
...
Effects:  
This technique is used alongside any interrupt that requires a defensive roll against an opponent’s Accuracy whilst you are at range 0 with that opponent . Using this jutsu requires you to have empty hands. You take a penalty of X to your roll, if you successfully defend, Halting Blow immediately acts as an attack at no extra cost, using the results of your dodge roll as its Accuracy and its speed for both damage and legal defenses from the opponent is equal to what it was when used as a defense. Your grapple rolls are increased by X for 10 IC after you use this technique. X has a maximum of 5\.
...
Kurokumaken requires the use of both arms. If this Technique deals a wound, then it applies 1 to the Torso, and 2 to the Arms instead of just a single Wound. 
...
Effects:  
This may be used outside of a grapple; in fact, it may only be used outside of a grapple. If you hit, you deal damage (which is not unblockable) and you initiate a grapple with your opponent and may immediately force a grapple roll against your opponent. If you beat their Def, you take them down and pin them as detailed in the D rank jutsu “Takedown”.
...
Effects:  
Your damage bonus is doubled for this attack.  
When you use this technique, your opponent makes a grapple roll vs your Grapple Off. If the opponent fails, they are Stunned (10) and you are Stunned (4). This technique ends the grapple and leaves your opponent prone.  
This move can be done from a clinch, but it only does it’s damage and stun if your opponent fails the grapple roll mentioned earlier. If they succeed, the attack does no damage, you do not end the clinch, your opponent gets \+5 to their roll next time you have to make a grapple roll against them, which does not stack with similar effects for failing grapple actions, and you get a stun of 10\.
...
Effects:  
You must use both your arms to keep your opponent in this hold. So long as you do so, they have a \-6 immobilization penalty and a \-6 penalty to their grapple rolls. This ends if you lose control of the grapple.  
Unlike the other grapple locks, the immobility from this technique does not stack with other grapple based immobilities.
...
Effects:  
Shishi Keishi is performed from outside of a grapple. If this technique misses, the "X" value is not paid. When performing Shishi Keishi, declare any grapple move of B rank or below that can be done from a clinch; if it hits, you initiate a grapple and then immediately perform that move. "X" is the cost and speed of the move you are using with Shishi Keishi.
